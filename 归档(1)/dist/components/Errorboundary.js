...
function (_React$Component) {
  ...
  function IsomorphicErrorBoundary() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(IsomorphicErrorBoundary)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(IsomorphicErrorBoundary, [{
