...
var catchreacterror = function catchreacterror(ErrorBoundary, TargetComponent) {
  var Boundary, InnerComponent;
  ...
  if (ErrorBoundary.catchreacterror) {
    ...
    if (ErrorBoundary && !ErrorBoundary.prototype.isReactComponent) {
      console.warn(
        "The ".concat(ErrorBoundary, " component is not a react component")
      );
...
var wrapComponent = function wrapComponent(Boundary) {
