...
function (_React$Component) {
  ...
  function DefaultErrorBoundary() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(DefaultErrorBoundary)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  _createClass(DefaultErrorBoundary, [{
