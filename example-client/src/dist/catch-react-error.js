...
var catchreacterror = function catchreacterror() {
  ...
  return function(InnerComponent) {
    ...
    if ((0, _index.is_server)()) {
      if (InnerComponent.prototype && InnerComponent.prototype.render) {
        ...
        !InnerComponent.prototype ||
        !InnerComponent.prototype.render
      ) {
        var originalFun = InnerComponent;

        InnerComponent = function InnerComponent() {
          try {
            return originalFun.apply(void 0, arguments);
          } catch (error) {
            console.error(error);
            return React.createElement("div", null, "Something is Wrong");
          }
