...
var _DefaultErrorBoundary = _interopRequireDefault(require("./components/DefaultErrorBoundary"));
...
var catchreacterror = function catchreacterror() {
  var Boundary = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _DefaultErrorBoundary["default"];
  return function (InnerComponent) {
    ...
    if ((0, _index.isComponentClass)(InnerComponent)) {
      ...
      function (_Component) {
        ...
        _createClass(WrapperComponent, [{
          ...
          value: function render() {
            ...
            return React.createElement(Boundary, null, (0, _index.isComponentClass)(InnerComponent) ? React.createElement(InnerComponent, _extends({}, this.props, {
              ref: forwardedRef
      ...
      return function (props) {
        return React.createElement(Boundary, null, React.createElement(InnerComponent, props));
      };
    }
  };
};
